@extends('dashboard.master', ['title' => 'Admin Create'])
@section('createAdmin-active', 'active')
@section('createAdmin-open', 'open')
@section('content')
            ...
            <div class="col-md-12 col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">{{ __('dashboard.create-admin') }}</h4>
                    </div>
                    <div class="card-body">
                        <form class="form form-horizontal" method="POST" action="{{ route('dashboard.admins.store') }}">
                            @csrf
                            @method('POST')
                            <div class="row">
                                <div class="col-6">
