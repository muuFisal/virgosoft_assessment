@extends('dashboard.master', ['title' => 'Role Update'])
        ...
        <div class="col-md-12 col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">{{ __('dashboard.update-role') }}</h4>
                </div>
                <div class="card-body">
                    <form class="form form-horizontal" method="POST" action="{{ route('dashboard.roles.update' , $role->id) }}">
                        @csrf
                        @method('PUT')
                                ...
                                @foreach (config('permessions_ar') as $key => $value)
                                    <div class="form-check form-check-inline col-md-2 mb-1">
                                        <input class="form-check-input" name="permession[]" type="checkbox"
                                            ...
                                            @checked(in_array($key ,json_decode($role->permession)))>
